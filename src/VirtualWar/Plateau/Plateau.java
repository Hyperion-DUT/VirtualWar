...
public class Plateau {
	...
	/**
	 * Utilisï¿½e dans un constructeur elle permet l'initialisation du tableau.
	 */
	...
	/**
	 * Retourne les coordonnï¿½es de la base de l'equipe qui est passï¿½e en paramatre.
	 * @param equipe valeur caracterisant une equipe.
	 * @return deux nombres qui donnent les coordonnï¿½es de la base.
	 */
	...
	public boolean estMine(int x, int y) {
		return (truePlateau[x][y] instanceof Case && truePlateau[x][y].estMine());
	}
	...
	public boolean estBase(int x, int y) {
		return truePlateau[x][y] instanceof Base;
	}
	/**
	...
	public boolean estObstacle(int x, int y) {
		return (truePlateau[x][y].estObstacle() && truePlateau[x][y] instanceof Case);
	}
	/**
	...
	public boolean estRobot(int x, int y) {
		return (truePlateau[x][y].estRobot() && truePlateau[x][y] instanceof Case);
	}
