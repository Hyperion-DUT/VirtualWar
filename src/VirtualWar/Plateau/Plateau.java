...
public class Plateau {
	...
	/**
	 * Utilis�e dans un constructeur elle permet l'initialisation du tableau.
	 */
	...
	/**
	 * Retourne les coordonn�es de la base de l'equipe qui est pass�e en paramatre.
	 * @param equipe valeur caracterisant une equipe.
	 * @return deux nombres qui donnent les coordonn�es de la base.
	 */
